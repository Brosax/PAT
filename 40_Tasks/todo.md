...
| T-20260616-02 | 测试激光注入台并完成一次成功的 DFA 注入攻击 | TBD | 用户指令 2026-06-16；更新 2026-07-28 | 定义测试目标、触发方式、基线与成功判据，然后执行并记录测试 | 当前主线；主题：激光错误注入；方向：DFA；记录成功条件与结果 |
| T-20260616-01 | 写一个激光注入攻击教程 | 2026-07-29 | 用户指令 2026-06-16；更新 2026-07-28 | 补写软件操作和参数调整部分，制作截图并完成教程首版 | 主题：激光错误注入；已完成基础目标摆放和摄像头定位；目标日期为尽量完成 |
| T-20260615-01 | 搭建自制 low-cost station | 2026-08-11 | 用户指令 2026-06-15；更新 2026-07-28 | 集成 Chipshooter、控制电脑、示波器和全能软件，验证完整实验台 | 第二优先级；相关项目：[[10_Projects/Low-Cost-Mounting-Station/Index]]；2026-07-28 已完成夹具打印；目标在两周内完成 |
