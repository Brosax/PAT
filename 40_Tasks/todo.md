...
| T-20260616-02 | 尝试一个新的激光注入攻击方式（DFA） | TBD | 用户指令 2026-06-16 | 设计并测试新的激光 DFA 攻击方式，明确实验条件和预期故障模式 | 主题：激光错误注入；方向：DFA |
...
| T-20260615-01 | Base station 软件开发 | TBD | 用户指令 2026-06-15 | 继续推进软件部分开发，并记录当前模块、接口和剩余问题 | 周一到周三主线任务；硬件部分已接近完成，当前重心转向软件 |

## Waiting

| ID | Task | Due | Source | Next | Notes |
| --- | --- | --- | --- | --- | --- |
| T-20260601-02 | 连接 AI 部门 LLM 服务器用于本地部署 | 2026-06-18 | 用户指令 2026-06-01 | 2026-06-18 恢复，确认 AI/LLM 服务器连接方式、认证、网络连通性、可用模型列表和本地部署调用接口 | 已暂缓；本周一到周三优先 base station 开发 |
| T-20260609-01 | 使用 AI 部门提供的新工具来连接 AI 服务器 | 2026-06-18 | 用户指令 2026-06-09 | 2026-06-18 使用新工具测试 AI/LLM 服务器连接并记录结果 | 支撑任务：T-20260601-02；已暂缓到周四处理 |
