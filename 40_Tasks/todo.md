...
| ID | Task | Due | Source | Next | Notes |
| --- | --- | --- | --- | --- | --- |
| T-20260514-01 | 看入职培训的视频 | TBD | 用户指令 2026-05-14 | 观看入职培训视频并记录需要后续处理的事项 | 今天并行处理；看完后补充完成情况或衍生待办 |
| T-20260616-03 | 生成一个操控代码审查软件的 AI 技能 | TBD | 用户指令 2026-06-16；更新 2026-08-12 | 开发代码审查工具的 Linux 版本 UI，明确输入输出和可复用操作流程 | 主题：AI 代码审查；当前进行 Linux 版本 UI 开发，AI 功能暂时延后 |
| T-20260616-02 | 测试激光注入台并完成一次成功的 DFA 注入攻击 | TBD | 用户指令 2026-06-16；更新 2026-08-12 | 开发自有控制软件，并编写 Arduino 目标板测试代码，继续进行原型测试 | 当前主线；主题：激光错误注入；方向：DFA；目标是完成一次成功注入攻击 |
| T-20260615-01 | 搭建自制 low-cost station | 2026-08-11 | 用户指令 2026-06-15；更新 2026-08-12 | 继续开发 Linux NUC 控制软件，验证 PicoScope、ChipShouter 和 KW45 目标板的完整工作链路 | 第二优先级；相关项目：[[10_Projects/Low-Cost-Mounting-Station/Index]]；已完成大部分硬件连接，控制主机为 Linux NUC，程序开发进展顺利 |

## Waiting

| ID | Task | Due | Source | Next | Notes |
| --- | --- | --- | --- | --- | --- |
| T-20260616-04 | 开发关于 AI 代码审查的原生 AI 工作流 | TBD | 用户指令 2026-06-16；更新 2026-08-12 | 待 Linux UI 和工具架构进一步明确后恢复 AI 工作流设计 | 主题：AI 代码审查；AI 部分暂时延后 |
...
| T-20260601-01 | 更新本周 OST PPT | 2026-06-01 | 用户指令 2026-06-01 | 已完成 | 已完成本周 OST 更新，用于周一会议 |
| T-20260601-03 | 上线基础版内部聊天服务 | 2026-06-01 | 用户指令 2026-06-01 | 已完成 | 已部署 AI 服务器内部聊天服务；LLM 服务器连接仍作为单独任务确认 |
| T-20260601-04 | 为内部聊天服务创建用户账号 | 2026-06-01 | 用户指令 2026-06-01 | 已完成 | 已为所有相关人员创建账号 |
