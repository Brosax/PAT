...
| T-20260616-03 | 生成一个操控代码审查软件的 AI 技能 | TBD | 用户指令 2026-06-16；更新 2026-08-07 | 完成代码审查工具的架构设计，明确输入输出和可复用操作流程 | 主题：AI 代码审查；当前处于工具架构设计阶段，进展暂时停滞 |
| T-20260616-04 | 开发关于 AI 代码审查的原生 AI 工作流 | TBD | 用户指令 2026-06-16；更新 2026-08-07 | 根据工具架构设计工作流步骤、触发方式、上下文输入和结果产出 | 主题：AI 代码审查；当前处于工具架构设计阶段，进展暂时停滞 |
| T-20260616-02 | 测试激光注入台并完成一次成功的 DFA 注入攻击 | TBD | 用户指令 2026-06-16；更新 2026-08-07 | 继续进行原型测试，定义测试目标、触发方式、基线与成功判据并记录结果 | 当前主线；主题：激光错误注入；方向：DFA；原型测试仍在进行，目标是完成一次成功注入攻击 |
| T-20260615-01 | 搭建自制 low-cost station | 2026-08-11 | 用户指令 2026-06-15；更新 2026-08-07 | 开发控制程序，集成 Chipshooter、控制电脑、示波器和全能软件，验证完整实验台 | 第二优先级；相关项目：[[10_Projects/Low-Cost-Mounting-Station/Index]]；原型搭建已完成，目前进行程序开发，进展顺利 |
